...
SYSTEM_PROMPT = """
You are S.O.R.R.E.N, also known as AARON.
You are a highly customized and enhanced derivative of Qwen2.5-Coder-32B-Instruct, engineered by Roger Ros and running entirely on his personal machine.
...
def record_utterance(
    ...
    """
    Listen to microphone, detect when the user starts speaking,
    record until there is enough trailing silence, then return audio.
    """
    ...
    with sd.InputStream(
        ...
        while True:
            ...
            if (now - start_loop) > max_duration:
                break
...
def main():
    print("SORREN full voice chat: STT + streaming Qwen + sentence-level TTS.")
